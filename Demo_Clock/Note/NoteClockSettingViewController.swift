...
class TDClockSettingViewController: LXMBaseViewController, UIPickerViewDelegate, UIPickerViewDataSource, UITextViewDelegate {
    ...
    fileprivate var targetAlarm: TDAlarm!
    ...
    class func loadFromStroyboardWithTargetAlarm(_ alarm: TDAlarm?) -> TDClockSettingViewController {
        let viewController = TDClockSettingViewController.swift_loadFromStoryboard("Main")
        if alarm == nil {
            viewController.isAddingAlarm = true
            viewController.targetAlarm = TDAlarm()
        } else {
...
extension TDClockSettingViewController {
    //    func test() {
...
extension TDClockSettingViewController {
    ...
    @IBAction func handleConfirmButtonTapped(_: UIButton) {
        ...
        if let todo = todo {
            ...
            TDAlarmManager.sharedInstance.alarmArray.append(alarm)
...
extension TDClockSettingViewController: RichEditorToolbarDelegate {
