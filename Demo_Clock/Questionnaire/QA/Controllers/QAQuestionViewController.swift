//
//  QAQuestionViewController.swift
//  Todo
//
...
extension QAQuestionViewController: UITableViewDataSource, UITableViewDelegate
{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 0:
            ...
            let subjectAttr = NSAttributedString(string: "\(question?.question ?? "未知异常")", attributes: [NSForegroundColorAttributeName: Q_A.Color.drakText , NSFontAttributeName: UIFont.systemFont(ofSize: 16)])
